#ifndef DG_ADT_SETVECTOR_H_
#define DG_ADT_SETVECTOR_H_
...
class StdSetVector {
 public:
  ...
  StdSetVector(It Start, It End) {
    insert(Start, End);
  }

  Vector &vec() const { return vector_; }
  ...
  void insert(It Start, It End) {
    for (; Start != End; ++Start)
      if (set_.insert(*Start).second) vector_.push_back(*Start);
  }
  ...
  bool operator==(const StdSetVector &that) const {
