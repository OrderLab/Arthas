#ifndef DG_ADT_MAPVECTOR_H
#define DG_ADT_MAPVECTOR_H
...
void StdMapVector<KeyT, ValueT, MapType, VectorType>::remove_if(Function Pred) {
  auto O = Vector.begin();
