...
enum WriteType { CMD_UNKNOWN = 0, CMD_VAR, CMD_DREF_VAR };

struct WriteCommand {
  WriteCommand() : type(CMD_UNKNOWN) {}

  WriteCommand(WriteType const t, const llvm::Value *v) : type(t), var(v) {}
...
struct ProgramStructure {
  ...
  ProgramStructure(const Module &M);
